...
1. Copy the plugin folder (e.g. `dues-calculator`) into your WordPress installation at:
...
3. In the WordPress admin, go to **Plugins → Installed Plugins** and activate **Dues Calculator**.
